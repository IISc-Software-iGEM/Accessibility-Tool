	...
	fetch(stylesURL)
		...
		.then(htmlContent => {
			...
			deuteranopiaButton.addEventListener('click', function() {
				...
				// Check if background color is red (case-insensitive)
				if (backgroundColor.toLowerCase() === 'red' || backgroundColor.startsWith('rgb(') && backgroundColor.includes(', 0, 0)')) {
					bodyElement.style.backgroundColor = 'black';
				}
				if (color.toLowerCase() === 'red' || color.startsWith('rgb(') && color.includes(', 0, 0)')) {
